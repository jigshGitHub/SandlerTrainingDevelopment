...
namespace SandlerRepositories
{
    public partial class ContactsRepository
    {
        ...
        public void UnArchiveContact(int contactsid, string CurrentUserId)
        {
            //Create the record
            db.ExecuteNonQuery("sp_UnArchiveContactRecord", new SqlParameter("@ContactId", contactsid), new SqlParameter("@CurrentUserId", CurrentUserId));
        }
