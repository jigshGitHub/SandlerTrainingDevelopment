...
namespace SandlerRepositories
{
    public partial class CompaniesRepository
    {
        ...
        public void UnArchiveCompany(int COMPANIESID, string CurrentUserId)
        {
            //Create the record
            db.ExecuteNonQuery("sp_UnArchiveCompanyRecord", new SqlParameter("@COMPANIESID", COMPANIESID), new SqlParameter("@CurrentUserId", CurrentUserId));
        }
