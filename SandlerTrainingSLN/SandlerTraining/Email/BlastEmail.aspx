...
<table width="100%">
 ...
 <td>Subject:&nbsp;&nbsp;<asp:TextBox ID="txtSubject" MaxLength="150"  Width="380px"  runat="server"></asp:TextBox>
 ...
 <tr style="color: Black; background-color: #EEEEEE; white-space: nowrap;"><td>Attach Document/Downloaded Report:&nbsp;&nbsp;<asp:FileUpload ID="EmailUpLoad" runat="server" /></td></tr>

 <tr style="color: Black; background-color: #DCDCDC; white-space: nowrap;"><td>Type your message text here:</td></tr>
 <tr>
 <td>
...
<tr style="color: Black; background-color: #EEEEEE; white-space: nowrap;"><td style="height:10px"></td></tr>

<tr style="color: Black; background-color: #DCDCDC; white-space: nowrap;"><td align="center"><asp:Button id="btnSend" Runat="server" Text="Send Blast Email" Style="background-color:#336699;
