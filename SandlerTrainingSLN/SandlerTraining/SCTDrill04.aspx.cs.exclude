...
public partial class SCTDrill04 : System.Web.UI.Page
{
    ...
    protected void CreateChart()
    {
        ...
        pieChart.Id = ChartID.SalesCycleTimeDrill4;
        pieChart.SWF = @"FusionChartLib/Pie3D.swf";
        pieChart.Caption = "Sales Cycle Time by Product - 12 Months to 18 Months";
