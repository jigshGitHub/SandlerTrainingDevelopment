<%@ Page Title="CRM" Language="C#" MasterPageFile="~/CRM.master" AutoEventWireup="true"
    CodeFile="CRMAddContact.aspx.cs" Inherits="CRMAddContact" %>
                ...
                <asp:DetailsView ID="dvContact" runat="server" Height="50px" Width="300px" AutoGenerateRows="False"
                    ...
                    <Fields>
                        <asp:TemplateField HeaderText="Select Company:">
                            <InsertItemTemplate>
                                <asp:DropDownList ID="ddlCompany" runat="server" DataSourceID="CompanyDS" DataTextField="Company_Name"
                        ...
                        <asp:TemplateField HeaderText="Name :">
                            <InsertItemTemplate>
                                ...
                                <asp:RequiredFieldValidator ID="reqFieldValNameTB" ControlToValidate="txtFullName"
                                    Display="Static" InitialValue="" runat="server" ErrorMessage="Please Enter Name to proceed.">
                    *
                        ...
                        <asp:TemplateField HeaderText="Total Account Value :">
                            <InsertItemTemplate>
                                <asp:TextBox ID="txtTotalActValue" onkeypress="EnterOnlyNumeric()" Width="380" runat="server"
                                    Text='<%# Bind("Total_ACT_Value") %>'></asp:TextBox>
                            </InsertItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Last Contact Date :">
                            <InsertItemTemplate>
                                ...
                                <asp:RequiredFieldValidator ID="LastContactDateRFV" ControlToValidate="LastContactDate"
                                    runat="server" ErrorMessage="Please Enter Last Contact Date to proceed.">
            *
        </asp:RequiredFieldValidator>
                            </InsertItemTemplate>
                        </asp:TemplateField>
