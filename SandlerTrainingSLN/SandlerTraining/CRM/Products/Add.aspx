<%@ Page Title="CRM - Add Product" Language="C#" MasterPageFile="~/CRM.master" AutoEventWireup="true" CodeFile="Add.aspx.cs" Inherits="CRM_Product_Add" %>

<%@ Import Namespace="SandlerRepositories" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <table>
        <tr>
            <th class="tdTC" style="width: 280px" align="left"> Add Product : </th>
        </tr>
        <tr>
        ...
        <tr>
            <td style="width: 280px"><asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowMessageBox="True" /></td>
        </tr>
        <tr>
            <td style="width: 280px"><asp:Label ID="lblResult" runat="server" ForeColor="Red"></asp:Label><br />
            <asp:ObjectDataSource ID="ProductDataSource" runat="server" InsertMethod="AddProduct" TypeName="SandlerRepositories.CompaniesRepository">
                <InsertParameters>
