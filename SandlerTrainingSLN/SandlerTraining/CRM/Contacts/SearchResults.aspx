                ...
                <div id="Report" runat="server">
                    <asp:GridView Width="100%" ID="gvContactsExport" runat="server" DataSourceID="SearchContactDS"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField ItemStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="Blue" DataField="Title" HeaderText="Title" />
                            <asp:BoundField ItemStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="Blue" DataField="ContactsDepartment" HeaderText="Contact's Department" />
                            <asp:BoundField ItemStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="Blue" DataField="ContactsRole" HeaderText="Contact's Role" />
                            <asp:BoundField ItemStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="Blue" DataField="MobilePhone" HeaderText="Mobile Phone" />
                            <asp:BoundField ItemStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="Blue" DataField="HomePhone" HeaderText="Home Phone"/>
                            <asp:BoundField ItemStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="Blue" DataField="Fax" HeaderText="Fax" />
                            <asp:BoundField ItemStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="Blue" DataField="PersonalEmail" HeaderText="Personal Email" />
                            ...
                            <asp:BoundField ItemStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="Blue" DataField="LastAttemptedDate" HeaderText="Last Attempted Date" DataFormatString="{0:d}" />
                            <asp:BoundField ItemStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="Blue" DataField="LastEmailedDate" HeaderText="Last Emailed Date" DataFormatString="{0:d}" />
                            <asp:BoundField ItemStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="Blue" DataField="LastMeetingDate" HeaderText="Last Meeting Date" DataFormatString="{0:d}" />
                            <asp:BoundField ItemStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="Blue" DataField="LetterSentDate" HeaderText="Letter Sent Date" DataFormatString="{0:d}" />
                            ...
                            <asp:BoundField ItemStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="Blue" DataField="Birthday" HeaderText="Birth Day" DataFormatString="{0:d}" />
                            <asp:BoundField ItemStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="Blue" DataField="Anniversary" HeaderText="Anniversary" DataFormatString="{0:d}" />
                            <asp:BoundField ItemStyle-HorizontalAlign="Center" DataField="BossName" HeaderText="Boss Name" HeaderStyle-ForeColor="Blue"/>
                            <asp:BoundField ItemStyle-HorizontalAlign="Center" DataField="SpouseName" HeaderText="Spouse Name" HeaderStyle-ForeColor="Blue"/>
                            <asp:BoundField ItemStyle-HorizontalAlign="Center" DataField="ReferredBy" HeaderText="ReferredBy" HeaderStyle-ForeColor="Blue"/>
                            <asp:BoundField ItemStyle-HorizontalAlign="Center" DataField="Notes" HeaderText="Notes" HeaderStyle-ForeColor="Blue"/>
                        </Columns>
                        <RowStyle BackColor="#EEEEEE" ForeColor="Black" />
                        <AlternatingRowStyle BackColor="#DCDCDC" />
                    </asp:GridView>
