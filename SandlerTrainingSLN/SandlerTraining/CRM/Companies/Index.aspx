<%@ Page Title="CRM - View Company" Language="C#" MasterPageFile="~/CRM.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Index.aspx.cs" Inherits="CompanyIndex" %>
            ...
            <td colspan="2">
                <asp:GridView Width="100%" ID="gvCompanies" runat="server" DataSourceID="SearchCompanyDS"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" HeaderStyle-ForeColor="Blue" DataField="TotalCompanyValue" SortExpression="dbo.GetTotalCompanyValue(COMPANIESID)" HeaderText="Total Company Value"  DataFormatString="{0:C}" />
