...
public partial class CompanyDETAIL : BasePage
{
    ...
    protected void CompanyDW_DataBound(object sender, EventArgs e)
    {
        ...
        //For Company Value Goal
        Label CompValueGoalLabel = new Label();
        CompValueGoalLabel = (Label)CompanyDW.FindControl("lblCOMPANYVALUEGOAL");
        if (CompValueGoalLabel != null)
        {
            if (CompValueGoalLabel.Text != "")
            {
