<%@ Page Title="CRM - Search Results - Company" Language="C#" MasterPageFile="~/CRM.master" AutoEventWireup="true"  EnableEventValidation="false" CodeFile="SearchResults.aspx.cs" Inherits="CRM_Companies_SearchResults" %>
     ...
     <tr>
       <th class="tdTC" align="left">Search Results : Company</th>
        ...
        <tr id="trExport" runat="server" visible="false">
            ...
            <asp:GridView Width="100%" ID="gvCompaniesExport" runat="server" DataSourceID="SearchCompanyDS" AutoGenerateColumns="False" DataKeyNames="COMPANIESID">
                    <Columns>
                        <asp:BoundField DataField="COMPANIESID" Visible="False" />
                        <asp:BoundField ItemStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="Blue" DataField="COMPANYNAME" HeaderText="Company Name" SortExpression="COMPANYNAME" />
                        <asp:BoundField ItemStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="Blue" DataField="Industry"  HeaderText="Industry" SortExpression="Industry" />
