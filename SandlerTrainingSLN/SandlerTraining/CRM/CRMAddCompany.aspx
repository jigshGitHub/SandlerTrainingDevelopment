<%@ Page Title="CRM - Add Company" Language="C#" MasterPageFile="~/CRM.master" AutoEventWireup="true" CodeFile="CRMAddCompany.aspx.cs" Inherits="UpdatedCRM_CRMAddCompany" %>

<%@Register TagPrefix="ew"  Namespace="eWorld.UI" Assembly="eWorld.UI, Version=1.9.0.0, Culture=neutral, PublicKeyToken=24d65337282035f2" %>
<%@ Import Namespace="SandlerRepositories" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
<table>
<tr><th class="tdTC" style="width: 280px" align="left">Add Company :</th></tr>
<tr><td style="width: 280px">
    <asp:DetailsView ID="dvCompany" runat="server" Height="50px" Width="300px" 
        AutoGenerateRows="False" DataSourceID="CompanyDataSource" DefaultMode="Insert" 
        CellPadding="3" BorderStyle="None" BorderWidth="1px" BackColor="White" 
        BorderColor="#999999" GridLines="Vertical" 
        oniteminserted="dvCompany_ItemInserted" 
        onmodechanging="dvCompany_ModeChanging" ondatabound="dvCompany_DataBound">
        <Fields>
          ...
          <asp:TemplateField HeaderText="Address :">
           ...
           <asp:TemplateField HeaderText="City :">
              <InsertItemTemplate>
                  ...
                  <asp:RequiredFieldValidator id="reqFieldValtxtCityTB"
           ...
           <asp:TemplateField HeaderText="State :">
              <InsertItemTemplate>
                  ...
                  <asp:RequiredFieldValidator id="reqFieldValtxtStateTB"
           ...
           <asp:TemplateField HeaderText="Zip :">
                    <InsertItemTemplate>
                        <asp:TextBox ID="txtZip" onkeypress="EnterOnlyNumeric()" Width="380" runat="server" Text='<%# Bind("Zip") %>'></asp:TextBox>
           ...
           <asp:TemplateField HeaderText="POC Last Name :">
              <InsertItemTemplate>
                  ...
                  <asp:RequiredFieldValidator id="reqFieldValPOCLastNameTB"
           ...
           <asp:TemplateField HeaderText="POC First Name :">
              <InsertItemTemplate>
                  ...
                  <asp:RequiredFieldValidator id="reqFieldValPOCFirstNameTB"
            ...
            <asp:TemplateField HeaderText="POC Phone :">
                 <InsertItemTemplate>
                    <asp:TextBox ID="txtPOCPhone" onkeypress="EnterOnlyNumeric()" MaxLength="50" Width="380" runat="server" Text='<%# Bind("POCPhone") %>'></asp:TextBox>
                    <asp:RequiredFieldValidator id="reqFieldValPOCPhoneTB"
            ...
            <asp:TemplateField HeaderText="Company Value Goal :">
              <InsertItemTemplate>
                  <asp:TextBox ID="txtComValueGoal" onkeypress="EnterOnlyNumeric()"  Width="380"  runat="server" Text='<%# Bind("COMPANYVALUEGOAL") %>'></asp:TextBox>
                  <asp:RequiredFieldValidator id="reqFieldValActValueTB"
                    ControlToValidate="txtComValueGoal"
                    Display="Static"
          ...
          <asp:TemplateField HeaderText="Industry:">
                   <InsertItemTemplate>
                        ...
                        <asp:RequiredFieldValidator id="industryRFV"
           ...
           <asp:TemplateField HeaderText="Rep First Name :">
            ...
            <asp:TemplateField HeaderText="Discussion Topic :">
              <InsertItemTemplate>
                  ...
                  <asp:RequiredFieldValidator id="reqFieldValDiscTopicTB"
                    ControlToValidate="txtDisTopic"
                    Display="Static"
         ...
         <asp:TemplateField HeaderText="Action Step :">
              <InsertItemTemplate>
                  ...
                  <asp:RequiredFieldValidator id="reqFieldValActStepTB"
...
id="AcctCreationDateRFV"
          ...
          <asp:TemplateField ShowHeader="False">
                <InsertItemTemplate>
                    ...
                    <asp:LinkButton ID="LinkButton2" runat="server" CausesValidation="False" CommandName="Cancel" Text="Back To Companies"  ForeColor="Blue" Font-Bold="true"></asp:LinkButton>
                </InsertItemTemplate>
           </asp:TemplateField>
    ...
    <asp:ObjectDataSource ID="CompanyDataSource" runat="server" InsertMethod="Insert" TypeName="SandlerRepositories.CompaniesRepository">
        <InsertParameters>
