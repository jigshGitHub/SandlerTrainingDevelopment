<%@ Page Title="CRM - View/Edit Company" Language="C#" MasterPageFile="~/CRM.master"
    AutoEventWireup="true" CodeFile="CRMViewCompany.aspx.cs" Inherits="UpdatedCRM_CRMViewCompany" %>
                ...
                <asp:DetailsView AutoGenerateRows="False" DataKeyNames="COMPANIESID" ID="CompanyDW"
                    ...
                    *
                        ...
                        <asp:TemplateField HeaderText="Zip :">
                            <EditItemTemplate>
                                <asp:TextBox ID="txtZip" onkeypress="EnterOnlyNumeric()" MaxLength="50" runat="server"
                    ...
                    *
                        ...
                        <asp:TemplateField HeaderText="Company Value Goal :">
                            <EditItemTemplate>
                                <asp:TextBox ID="txtCOMPANYVALUEGOAL" onkeypress="EnterOnlyNumeric()" MaxLength="50"
                                    runat="server" Text='<%# Bind("COMPANYVALUEGOAL") %>'></asp:TextBox>
