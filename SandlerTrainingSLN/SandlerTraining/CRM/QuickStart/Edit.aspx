<%@ Page Title="QuickStart - Add" Language="C#" MasterPageFile="~/CRM.master" AutoEventWireup="true"
    CodeFile="Edit.aspx.cs" Inherits="CRM_QuickStart_Index" %>
            ...
            <table>
                            ...
                            <tr style="color: Black; background-color: #DCDCDC; white-space: nowrap;">
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvDDLOpportunity" ControlToValidate="ddlOpportunity"
                                        Display="Dynamic" InitialValue="0" runat="server" ErrorMessage="Please Select A Opportunity From The List."
                                        Text="">
                                    </asp:RequiredFieldValidator>
                ...
                <tr>
                    <td>
                        ...
                        <asp:GridView ID="gvNotesHistory" runat="server" AutoGenerateColumns="false" AutoGenerateEditButton="true"
