...
public partial class SCTDrill02 : System.Web.UI.Page
{
    ...
    protected void CreateChart()
    {
        ...
        pieChart.Id = ChartID.SalesCycleTimeDrill2;
        pieChart.SWF = @"FusionChartLib/Pie3D.swf";
        pieChart.Caption = "Sales Cycle Time by Product - 3 Months to 6 Months";
