...
set @user_Name = 'natasha.wood'--firstname.lastname
set @_email = 'natasha@sandler.com'
set @franchiseeId = 21
...
BEGIN TRY
	...
	BEGIN TRANSACTION;
		...
		BEGIN
			...
			EXEC [dbo].[aspnet_UsersInRoles_AddUsersToRoles] @ApplicationName = 'SandlerTraining', @UserNames = @user_Name, @RoleNames = 'FranchiseeUser', @CurrentTimeUtc = @CurrentTime;
