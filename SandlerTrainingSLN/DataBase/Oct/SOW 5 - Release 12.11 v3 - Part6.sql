INSERT [dbo].[TBL_CHART] ([TypeOfChart], [Caption], [SWFile], [ChartID], [NumberSuffix], [SNumberSuffix], [XaxisName], [YaxisName], [CanvasBgColor], [BgColor], [CanvasBgAlpha], [BgAlpha], [PieRadius], [EnableRotation], [ShowLegend], [ShowLabels], [PlotGradientColor], [DrillLevelChartIDs], [IsActive], [LastUpdatedDate], [LastCreatedDate], [LastUpdatedBy], [LastCreatedBy]) VALUES ( N'Chart', N'Product Sold To Company Name by Product (By Month)', N'MSColumn3D.swf', N'ProductSoldToCompanyByProductByMonth', NULL, NULL, NULL, N'Product Quantity Sold', N'FFFFFF', N'FFFFFF', N'100', N'100', NULL, N'0', N'0', N'0', NULL, N'ProductSalesByCompanyQuantity_ProductSalesByCompanyValue', 1, GetDate(), GetDate(), NULL, NULL)
GO
