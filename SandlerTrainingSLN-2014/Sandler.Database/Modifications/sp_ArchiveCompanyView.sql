...
/****** Object:  StoredProcedure [dbo].[sp_ArchiveCompanyView]    Script Date: 03/03/2014 22:30:14 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_ArchiveCompanyView]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[sp_ArchiveCompanyView]
GO
...
Create Procedure [dbo].[sp_ArchiveCompanyView](
