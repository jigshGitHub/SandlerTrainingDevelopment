...
function ng_reportSFOACtrl($scope, $http) {
    angular.element(document).ready(function () {
       ...
       //@*Edit record*@
        $('#SOASearchgrid').on('click', '.editsa', function (e) {
            ...
            e.preventDefault();
            var item = $("#SOASearchgrid").data("kendoGrid").dataItem($(this).closest("tr"));
